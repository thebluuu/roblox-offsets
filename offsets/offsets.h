...
namespace offsets {
  ...
  constexpr std::uint32_t LocalPlayer = 0x110;
  ...
  constexpr std::uint32_t CurrentCamera = 0x410;
  ...
  constexpr std::uint32_t Brightness = 0x114;
  constexpr std::uint32_t FogEnd = 0x124;
  constexpr std::uint32_t GlobalShadows = 0x130;
